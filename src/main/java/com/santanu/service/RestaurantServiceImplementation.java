...
import com.santanu.repository.AddressRepository;
import com.santanu.repository.RestaurantRepository;
...
public class RestaurantServiceImplementation implements RestaurantService {
    ...
    private static Restaurant getRestaurant(CreateRestaurantRequest req, User user, Address savedAddress) {
    ...
    public Restaurant createRestaurant(CreateRestaurantRequest req, User user) {
        ...
        Restaurant restaurant = getRestaurant(req, user, savedAddress);
